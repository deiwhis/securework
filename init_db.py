...
run("""
INSERT IGNORE INTO sistema (nombre_sistema, descripcion) VALUES
...
run("""
INSERT IGNORE INTO capacitacion (nombre, descripcion, obligatoria, fecha_inicio, fecha_fin) VALUES
...
if errores == 0:
    ...
    print(f"\nSchema cargado con {errores} error(es).")
